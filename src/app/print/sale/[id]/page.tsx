...
import { getSaleReceiptViewModel, type ReceiptViewModel } from "@/services/receipt.service";
...
export default async function SaleReceiptPrintPage({
  params,
  searchParams,
}: {
  ...
  let errorMessage = "";
  try {
    receipt = await getSaleReceiptViewModel(user, id);
  } catch (error) {
